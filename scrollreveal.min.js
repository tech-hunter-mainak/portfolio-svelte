...
var ScrollReveal = (function () {
	...
	function u(e, t) {
		...
		if ('string' == typeof e)
			try {
				...
				h.call(this, 'Invalid selector.', e), n;
				return [];
			}
		return [];
	}
	...
	function a(e, t) {
		var n = this,
			...
			s = 0;
		e.callbackTimer &&
			((s = Date.now() - e.callbackTimer.start), window.clearTimeout(e.callbackTimer.clock)),
			r(e.node),
			(e.callbackTimer = {
				start: Date.now(),
	...
	function l(e, t) {
		...
		if (n) {
			...
			if (!n.blocked.head && i === [].concat(o.head).pop() && i >= [].concat(r.body).shift())
				return g.call(this, n, i, -1, t), c.call(this, e, { reveal: !0, pristine: t });
	...
	function b() {
		...
		t.call(this),
			f(this.store.elements, function (e) {
				...
				e.visible
					? (t.push(e.styles.opacity.computed), t.push(e.styles.transform.generated.final))
					: (t.push(e.styles.opacity.generated), t.push(e.styles.transform.generated.initial)),
					e.node.setAttribute(
						'style',
						t
							.filter(function (e) {
		...
		try {
			...
			f(
				i.reduce(function (e, t) {
					...
					i
						? (E(n, c.store.elements[i]), n.node.setAttribute('style', n.styles.inline.computed))
						: ((n.id = y()), (n.node = t), (n.seen = !1), (n.revealed = !1), (n.visible = !1));
					...
					return (
						s.contains(t) &&
							(null ===
								...
								})(s, d, c.store.containers)) && ((o = y()), d.push({ id: o, node: s })),
							(n.config = r),
							(n.containerId = o),
							(n.styles = m(n)),
		...
		void 0 === e && (e = { type: 'init' }),
			...
			k(function () {
				...
				f(i.store.containers, function (e) {
					...
					e.scroll && (e.direction = { x: T(t.left - e.scroll.left), y: T(t.top - e.scroll.top) }),
						(e.scroll = t);
				}),
					f(t, function (e) {
	...
	function $(e) {
		var t;
		if ((void 0 === e && (e = {}), void 0 === this || Object.getPrototypeOf(this) !== $.prototype))
			return new $(e);
		if (!$.isSupported())
			return h.call(this, 'Instantiation failed.', 'This browser is not supported.'), n;
		try {
			t = E({}, M || r, e);
		} catch (e) {
